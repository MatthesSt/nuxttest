import { version, getCurrentInstance, defineComponent, computed, ref, h, resolveComponent, reactive, useSSRContext, createApp, toRef, isRef, defineAsyncComponent, provide, onErrorCaptured, unref, inject, nextTick, watchEffect } from 'vue';
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import('./error-component.7e36842e.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();

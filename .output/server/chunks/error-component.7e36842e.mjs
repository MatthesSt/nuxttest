...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404.4b4f644b.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500.43f51947.mjs').then((r) => r.default || r));
...
//# sourceMappingURL=error-component.7e36842e.mjs.map
